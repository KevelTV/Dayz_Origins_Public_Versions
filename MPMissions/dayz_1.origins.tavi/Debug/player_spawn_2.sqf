...
//Debug Info
	...
	<t size='1.15' font='Bitstream'align='center'color='#5882FA'>YOURNAME.RU</t><br/><br/>
	<t size='1.15' font='Bitstream'align='center'color='#5882FA'>Admin: [Liq]Kevel</t><br/><br/>
	<t size='0.95'font='Bitstream'align='center'color='#2ECCFA'>В бою %5</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Игроков на сервере: </t><t size='0.95 'font='Bitstream' align='right'>%10</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Убийств: </t><t size='0.95' font='Bitstream' align='right'>%1</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Убито мирных: </t><t size='0.95' font='Bitstream' align='right'>%2</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Убито бандитов: </t><t size='0.95' font='Bitstream' align='right'>%3</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Зомби (живых/всего): </t><t size='0.95' font='Bitstream' align='right'>%7/%6</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Человечность: </t><t size='0.95' font='Bitstream' align='right'>%4</t><br/>
    <t size='0.95' font='Bitstream' align='left'>Кровь: </t><t size='0.95' font='Bitstream' align='right'>%9</t><br/>
	<t size='1.15'font='Bitstream'align='center'color='#2ECCFA'>Fps: %8</t><br/>",
	...
	<t size='1.15' font='Bitstream'align='center'color='#5882FA'>YOURNAME.RU</t><br/><br/>
	<t size='1.15' font='Bitstream'align='center'color='#5882FA'>Admin: [Liq]Kevel</t><br/><br/>
	<t size='0.95'font='Bitstream'align='center'color='#2ECCFA'>Не в бою</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Игроков на сервере: </t><t size='0.95 'font='Bitstream' align='right'>%10</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Убийств: </t><t size='0.95' font='Bitstream' align='right'>%1</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Убито мирных: </t><t size='0.95' font='Bitstream' align='right'>%2</t><br/>
	<t size='0.95' font='Bitstream' align='left'>Убито бандитов: </t><t size='0.95' font='Bitstream' align='right'>%3</t><br/>
